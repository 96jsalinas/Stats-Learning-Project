...
* The best mean CV ROC-AUC occurs at the selected \(k\) with a standard deviation of about 0.009, confirming stability across folds. Nearby values are extremely close, indicating that performance is fairly stable in the high-\(k\) region.
